<template>
  <div class="route-admin">
    ...
    <el-table :data="tableVisibleData" border style="width: 100%" ref="multipleTable" @selection-change="handleSelectionChange">
      <el-table-column prop="pk_ROUTE" label="System User ID" width="245"></el-table-column>
      <el-table-column prop="service_CODE" label="系统用户编号"></el-table-column>
      <el-table-column prop="sender_ORG" label="系统用户平台"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    search() {
    	this.axios.get(this.api + '/selectbycondition',{params: {key: this.select_word}}).then((response) => {
    		this.tableData = response.data.data;
